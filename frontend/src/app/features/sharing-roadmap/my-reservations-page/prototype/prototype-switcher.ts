...
export const PROTOTYPE_VARIANTS: ReadonlyArray<{
  ...
  { key: 'A', name: 'Dense status board' },
  { key: 'B', name: 'Trip-oriented cards' },
  { key: 'C', name: 'Inbox / needs-action' },
];

/** PROTOTYPE-only floating switcher — hidden outside development builds. */
@Component({
  selector: 'app-my-reservations-prototype-switcher',
  template: `
    @if (show()) {
      <div class="proto-switcher" role="toolbar" aria-label="My reservations prototype variants">
        <button
          type="button"
        ...
        <div class="proto-switcher__label">
          <span class="proto-switcher__badge">PROTOTYPE</span>
...
export class MyReservationsPrototypeSwitcher {
