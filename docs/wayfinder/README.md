...
**[Typical Placement surfaces design spec](https://github.com/captainDuckay/we-share-stuff/issues/1)** (`wayfinder:map`)

Do not treat files under `docs/wayfinder/maps/` or `docs/wayfinder/tickets/` as source of truth. They were early local drafts before GitHub labels and issues were available; prefer the linked GitHub issues.
